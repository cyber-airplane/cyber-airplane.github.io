...
const resolveRedirects = async (url, maxRedirects, timeoutEachRedirect, userAgent, logger, signal) => {
  ...
  while (redirectCount < maxRedirects) {
    try {
      ...
      options.signal = signal ? combineAbortSignals(signal, timeoutController.signal) : timeoutController.signal;
      try {
...
export {
  CORSError as C,
  extractAspectRatioFromHtml as a,
  generateHtml as b,
  calculateAspectRatio as c,
  createResponsiveImageWithContainer as d,
  escapeHtml as e,
  fetchOEmbedData as f,
  generateFallbackHtml as g,
  createResponsiveImageTag as h,
  isValidUrl as i,
  generateResponsiveImageStyles as j
};
//# sourceMappingURL=html-generator-RU0HacgN.js.map
