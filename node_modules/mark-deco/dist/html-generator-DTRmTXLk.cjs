...
const applyScrapingRule = (rule, $, url, logger) => {
  ...
  const $head = cheerio__namespace.load($("head").html() || "");
  const context = {
    $,
    $head,
    url,
...
const generateCardHtml = (data, originalUrl, options = {}) => {
  ...
  if (imageUrl && displayFields.image !== void 0) {
    allItems.push({
      ...
      section: "image",
      html: htmlGenerator.createResponsiveImageWithContainer(
        escapeHtml(imageUrl),
  ...
  if (faviconUrl && displayFields.favicon !== void 0) {
    faviconHtml = htmlGenerator.createResponsiveImageTag(
...
exports.extractEnhancedData = extractEnhancedData;
...
//# sourceMappingURL=html-generator-DTRmTXLk.cjs.map
